...
<div class="mx-auto max-w-2xl px-4 py-10">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Stay up to date with your activity') }}</p>
        </div>
    ...
    <div class="space-y-3">
        ...
        <div class="flex flex-col items-center justify-center rounded-2xl py-24 ring-1 ring-zinc-100 dark:ring-zinc-800 text-zinc-400 dark:text-zinc-500">
            ...
            <p class="text-base font-semibold text-zinc-600 dark:text-zinc-300">{{ __("You're all caught up!") }}</p>
            <p class="text-sm mt-1">{{ __('No notifications yet.') }}</p>
        </div>
        @endforelse
    </div>

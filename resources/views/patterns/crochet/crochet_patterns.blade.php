...
<section class="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50 to-sky-50 py-16 dark:from-emerald-950/30 dark:via-teal-950/30 dark:to-sky-950/30">
    ...
    <div class="relative max-w-6xl mx-auto px-6 lg:px-12">
        <p class="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-emerald-700 ring-1 ring-emerald-200 dark:bg-zinc-900/70 dark:text-emerald-200 dark:ring-emerald-800/60">
            {{ __('Crochet Spotlight') }}
        </p>
        <div class="mt-6 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="max-w-3xl">
                <h1 class="text-4xl font-bold tracking-tight text-emerald-900 sm:text-5xl dark:text-white">{{ __('Curated crochet patterns') }}</h1>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="#collections" class="rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition hover:translate-y-[-1px] hover:shadow-emerald-500/35">{{ __('Browse patterns') }}</a>
                </div>
            </div>
            <div class="grid w-full max-w-md grid-cols-2 gap-4 rounded-2xl bg-white/80 p-4 shadow-xl ring-1 ring-emerald-100 backdrop-blur dark:bg-zinc-900/70 dark:ring-emerald-900/40">
                <div class="rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 p-4 text-white shadow-lg">
                    ...
                    <p class="mt-1 text-sm text-emerald-100">{{ __('Fresh patterns ready to start.') }}</p>
                </div>
                <div class="flex flex-col justify-between rounded-xl bg-white p-4 ring-1 ring-emerald-100 dark:bg-zinc-800 dark:ring-emerald-900/50">
                    <div>
                        <p class="text-sm font-semibold text-emerald-800 dark:text-emerald-100">{{ __('Your queue') }}</p>
...
<section id="patterns" class="bg-white py-12 dark:bg-zinc-900">
    <div class="max-w-6xl mx-auto px-6 lg:px-12">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-sm font-semibold text-emerald-700 dark:text-emerald-200">{{ __('Pick your lane') }}</p>
                <h2 class="text-3xl font-bold text-zinc-900 dark:text-white">{{ __('What crochet are you into?') }}</h2>
        ...
        @if($selectedCategory)
            ...
            <div id="patterns" class="mt-12">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <a href="{{ route('patterns.crochet') }}" class="text-sm font-semibold text-emerald-700 underline-offset-4 hover:underline dark:text-emerald-200">{{ __('View all') }}</a>
                </div>
                ...
                @else
                    <div class="mt-8 rounded-2xl border border-dashed border-emerald-200 bg-emerald-50 p-12 text-center dark:border-emerald-900/40 dark:bg-zinc-900/70">
                        ...
                        <a href="{{ route('patterns.crochet') }}" class="mt-4 inline-block rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700">{{ __('View all categories') }}</a>
                    </div>
                @endif
            </div>
        @else
            ...
            <div id="patterns" class="mt-12">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        <h3 class="mt-1 text-2xl font-bold text-zinc-900 dark:text-white">{{ __('Newest crochet patterns') }}</h3>
                    </div>
                </div>
                ...
                @else
                    <div class="mt-8 rounded-2xl border border-dashed border-emerald-200 bg-emerald-50 p-12 text-center dark:border-emerald-900/40 dark:bg-zinc-900/70">
                        <h3 class="text-lg font-bold text-emerald-900 dark:text-white">{{ __('No patterns yet') }}</h3>
                        <p class="mt-2 text-sm text-emerald-700 dark:text-emerald-300">{{ __('New patterns will appear here soon!') }}</p>
                    </div>
                @endif
            </div>
        @endif
...
<section id="collections" class="bg-gradient-to-br from-emerald-50 via-white to-teal-50 py-14 dark:from-emerald-950/20 dark:via-zinc-900 dark:to-teal-950/20">
    <div class="max-w-6xl mx-auto px-6 lg:px-12">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-sm font-semibold text-emerald-700 dark:text-emerald-200">{{ __('Community sets') }}</p>
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ route('collections.select-patterns') }}" class="rounded-xl bg-gradient-to-r from-teal-800 to-teal-900 px-5 py-3 text-sm font-semibold text-white shadow-lg hover:from-teal-700 hover:to-teal-800 transition-all duration-200 transform hover:scale-105 whitespace-nowrap">
                        <svg class="inline-block h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        {{ __('Add Collection') }}

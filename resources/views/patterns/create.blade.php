...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-sky-50 via-white to-blue-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-blue-950/20 py-12">
    <div class="container mx-auto px-4 max-w-4xl">
        <!-- Header -->
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-800/30 dark:to-blue-800/30 shadow-inner mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.999 511.999" class="w-14 h-14" xml:space="preserve">
        ...
        <!-- Form Card -->
        <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-sky-100 dark:border-sky-900/40 overflow-hidden">

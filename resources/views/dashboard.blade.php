    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="fade-up mb-8 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-4">
                ...
                @else
                    @php $dashAvatarColor = auth()->user()->avatarColor(); @endphp
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl text-xl font-black text-white shadow {{ $dashAvatarColor ? '' : 'bg-gradient-to-br from-violet-500 to-fuchsia-500' }}"
                         {!! $dashAvatarColor ? 'style="background-color: ' . e($dashAvatarColor) . '"' : '' !!}>
                ...
                <div>
                    ...
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ __('Here\'s what\'s happening with your account.') }}</p>
                </div>
            </div>
        ...
        <div class="fade-up grid grid-cols-2 gap-4 md:grid-cols-4" style="animation-delay:.05s">
            ...
            <div class="card-hover rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">{{ __('Patterns') }}</p>
                <p class="text-4xl font-black text-violet-600 dark:text-violet-400">{{ $patternsCount }}</p>
                <a href="{{ route('my-patterns') }}" class="mt-2 inline-block text-xs text-violet-500 hover:underline">{{ __('View all →') }}</a>
            </div>

            <div class="card-hover rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">{{ __('Posts') }}</p>
                <p class="text-4xl font-black text-blue-600 dark:text-blue-400">{{ $postsCount }}</p>
                <a href="{{ route('posts.index') }}" class="mt-2 inline-block text-xs text-blue-500 hover:underline">{{ __('View all →') }}</a>
            </div>

            <div class="card-hover rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">{{ __('Followers') }}</p>
            ...
            <div class="card-hover rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 mb-2">{{ __('Following') }}</p>
        ...
        <div class="mt-6 fade-up" style="animation-delay:.08s">
            <div class="rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm">
                <h2 class="text-base font-bold text-zinc-900 dark:text-white mb-5">{{ __('My Activity') }}</h2>
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-pink-50 dark:bg-pink-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Likes Received') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-sky-50 dark:bg-sky-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Comments Received') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-amber-50 dark:bg-amber-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Patterns Saved') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-violet-50 dark:bg-violet-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Patterns This Month') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Posts This Month') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center rounded-xl bg-emerald-50 dark:bg-emerald-900/20 py-4 px-3 text-center">
                        ...
                        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">{{ __('Comments Given') }}</p>
                    </div>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 fade-up" style="animation-delay:.1s">
                <div class="rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 shadow-sm overflow-hidden">
                    <div class="flex items-center justify-between px-6 py-4 border-b border-zinc-100 dark:border-zinc-800">
                        <h2 class="text-base font-bold text-zinc-900 dark:text-white">{{ __('My Recent Patterns') }}</h2>
                        <a href="{{ route('my-patterns') }}" class="text-xs font-semibold text-violet-600 dark:text-violet-400 hover:underline">{{ __('View all →') }}</a>
                    </div>
                    ...
                    @if($recentPatterns->isEmpty())
                        <div class="flex flex-col items-center justify-center py-16 text-zinc-400 dark:text-zinc-500">
                            ...
                            <p class="text-sm">{{ __('No patterns yet.') }}</p>
                            <a href="{{ route('patterns.create') }}" class="mt-3 text-xs font-semibold text-violet-600 hover:underline">{{ __('Upload your first pattern') }}</a>
                        </div>
                    @else
                        <div class="divide-y divide-zinc-100 dark:divide-zinc-800">
                            ...
                            <div class="flex items-center gap-4 px-6 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400 capitalize">{{ $pattern->category }} · {{ $pattern->difficulty ?? __('No difficulty set') }}</p>
                                </div>
                                <div class="flex items-center gap-3 flex-shrink-0">
                                    <span class="text-xs text-zinc-400 dark:text-zinc-500">{{ $pattern->created_at->diffForHumans() }}</span>
                                    <a href="{{ route('patterns.view', $pattern) }}" class="text-xs font-semibold text-violet-600 dark:text-violet-400 hover:underline">{{ __('View') }}</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="mt-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm fade-up" style="animation-delay:.12s">
                    <div class="flex items-center justify-between mb-5">
                        <h2 class="text-base font-bold text-zinc-900 dark:text-white">{{ __('This Week') }}</h2>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="rounded-xl bg-pink-50 dark:bg-pink-900/20 p-4 text-center">
                            ...
                            <p class="mt-1 text-xs font-medium text-pink-500 dark:text-pink-400">{{ __('Likes') }}</p>
                        </div>
                        <div class="rounded-xl bg-sky-50 dark:bg-sky-900/20 p-4 text-center">
                            ...
                            <p class="mt-1 text-xs font-medium text-sky-500 dark:text-sky-400">{{ __('Comments') }}</p>
                        </div>
                        <div class="rounded-xl bg-violet-50 dark:bg-violet-900/20 p-4 text-center">
                            ...
                            <p class="mt-1 text-xs font-medium text-violet-500 dark:text-violet-400">{{ __('New Followers') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6 fade-up" style="animation-delay:.15s">
                ...
                <div class="rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
                    <h2 class="text-base font-bold text-zinc-900 dark:text-white mb-4">{{ __('Quick Links') }}</h2>
                    <div class="space-y-1">
                            ...
                            <a href="{{ route('posts.show', $post) }}" class="flex items-center gap-3 group">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-zinc-400 dark:text-zinc-500">
                                        {{ $post->likes_count }} {{ __('likes') }} · {{ $post->created_at->diffForHumans() }}
                                    </p>
                                </div>
                            </a>
                            @endforeach

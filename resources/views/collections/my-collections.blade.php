        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg border border-teal-100 dark:border-teal-900/40">
                <div class="flex items-center">
                    <div class="p-4 rounded-full bg-teal-100 dark:bg-teal-900/40">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg border border-emerald-100 dark:border-emerald-900/40">
                <div class="flex items-center">
                    <div class="p-4 rounded-full bg-emerald-100 dark:bg-emerald-900/40">
                        <svg class="h-12 w-12 text-emerald-600 dark:text-emerald-400 transform rotate-45" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg border border-blue-100 dark:border-blue-900/40">
                <div class="flex items-center">
                    <div class="p-4 rounded-full bg-blue-100 dark:bg-blue-900/40">
                        <svg class="h-12 w-12 text-blue-600 dark:text-blue-400 transform" fill="currentColor" viewBox="0 0 512 768">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg border border-purple-100 dark:border-purple-900/40">
                <div class="flex items-center">
                    <div class="p-4 rounded-full bg-purple-100 dark:bg-purple-900/40">
                        <svg class="h-10 w-10 text-purple-600 dark:text-purple-400" fill="currentColor" viewBox="0 0 274 274">
